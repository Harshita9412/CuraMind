...
const initReviewData = require("./reviews.js");  // Import reviews data
const Service = require("../models/Services"); 
const Review = require("../models/Reviews"); // Import Review model

const MONGO_URL = 'mongodb+srv://Harshita9412:Ayu9412@cluster0.bbipg.mongodb.net/CuraMind?retryWrites=true&w=majority&appName=Cluster0';
